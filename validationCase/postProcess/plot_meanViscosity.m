...
data1 = readtable('viscosity_HB10_SST.csv');
data1=data1{:,:};
time1=data1(:,1);
vel1= data1 (:,2);

data2 = readtable('viscosity_HB10_SSTHB.csv');
data2=data2{:,:};
time2=data2(:,1);
vel2= data2 (:,2);
% 
data3 = readtable('reference_viscosity_HB10.csv');
data3=data3{:,:};
time3=data3(:,1);
vel3= data3 (:,2);
...
scatter(time3, vel3,50,  'o','MarkerEdgeColor', 'black','Linewidth',1); 
hold on;
...
% Save as PDF
print('./validation_meanviscosityHB', '-dpdf', '-painters');
